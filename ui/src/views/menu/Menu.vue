      ...
      <div :class="isOpen ? 'block' : 'hidden'" class="pt-2 pb-4 lg:flex">
        <nav class="w-full">
          ...
          <div>
            ...
            >{{ $t('annotations.annotations') }}</button>
          ...
          <div>
            ...
            >{{ $t('environments.environments') }}</button>
          ...
          <div>
            ...
            >{{ $t('executions.executions', 2) }}</button>
...
const { isOpen, menu, getSelectedMenu, getActiveLink } = menus()
</script>
